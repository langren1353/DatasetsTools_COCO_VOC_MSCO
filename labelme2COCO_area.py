...
'''
使用的时候直接在./*.json目录下用就可以了，然后会在当前目录生成一个new.json
同时会自动生成对应的图片，无需拷贝图片过来了
带了area参数的
注意可能需要activate pytorch36
'''
...
class labelme2coco(object):
    ...
    def image(self, data, num):
        ...
        cv2.imwrite(data['imagePath'], img)
    ...
    def annotation(self, points, label, num):
        ...
        annotation['area'] = abs(cv2.contourArea(np.array(points)))
